...
import { faRectangleList, faBookOpen, faCalendarAlt, faShoppingBag, faChartLine, faSlidersH, faIdBadge, faChartPie, faStickyNote } from '@fortawesome/free-solid-svg-icons';
